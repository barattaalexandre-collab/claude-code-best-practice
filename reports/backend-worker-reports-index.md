...
26. `probat-audit-mobai-post-corrections.md`
   - Audit MobAI post-corrections CC: GO sous réserve, P0 NLU create/modify et FAB premier clic intermittent.
27. `probat-p0-nlu-fab-execution-status.md`
   - Statut d'exécution des P0 NLU/FAB: PR backend #14 et front #15, P0-A validé E2E, P0-B à confirmer par QA humaine courte.
28. `probat-crm-contacts-ai-voice-regression.md`
